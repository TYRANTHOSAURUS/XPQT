...
export const ERROR_MESSAGES_NL: Record<KnownErrorCode, ErrorMessage> = {
  ...
  // NL parity for codes registered in messages.en.ts §F1 Sub-PR A.
  'person.search_failed': { title: 'Kon niet zoeken in personen' },
  'person.list_failed': { title: 'Kon personen niet laden' },
  'person.create_failed': { title: 'Kon die persoon niet aanmaken' },
  'person.update_failed': { title: 'Kon die persoon niet bijwerken' },
  'person.membership_update_failed': { title: 'Kon de organisatie van die persoon niet bijwerken' },
  'person.membership_remove_failed': { title: 'Kon dat organisatie-lidmaatschap niet verwijderen' },
  'person.location_grant_list_failed': { title: 'Kon locatie-rechten niet laden' },
  'person.location_grant_create_failed': { title: 'Kon dat locatie-recht niet toevoegen' },
  'person.location_grant_remove_failed': { title: 'Kon dat locatie-recht niet verwijderen' },
  'person.authorization_load_failed': { title: 'Kon de autorisatie van die persoon niet ophalen' },

  'maintenance_plans.list_failed': { title: 'Kon onderhoudsplannen niet laden' },
  'maintenance_plans.lookup_failed': { title: 'Kon dat onderhoudsplan niet opzoeken' },
  'maintenance_plans.create_failed': { title: 'Kon dat onderhoudsplan niet aanmaken' },
  'maintenance_plans.update_failed': { title: 'Kon dat onderhoudsplan niet bijwerken' },
  'maintenance_plans.dependents_check_failed': { title: 'Kon afhankelijkheden van het onderhoudsplan niet controleren' },
  'maintenance_plans.deactivate_failed': { title: 'Kon dat onderhoudsplan niet deactiveren' },
  'maintenance_plans.delete_failed': { title: 'Kon dat onderhoudsplan niet verwijderen' },
  'maintenance_plans.actor_lookup_failed': { title: 'Kon de actor voor het onderhoudsplan niet ophalen' },
  'pm_generator.asset_lookup_failed': { title: 'Kon een preventief-onderhoud-asset niet opzoeken' },
  'pm_generator.asset_list_failed': { title: 'Kon preventief-onderhoud-assets niet laden' },
  'pm_generator.create_pm_work_order_failed': { title: 'Kon die preventief-onderhoud-werkorder niet aanmaken' },
  'pm_generator.advance_failed': { title: 'Kon dat onderhoudsplan niet vooruit zetten' },
  'pm_generator.due_plans_list_failed': { title: 'Kon openstaande onderhoudsplannen niet laden' },
  'pm_generator.tenants_list_failed': { title: 'Kon tenants voor preventief onderhoud niet laden' },

  'order.master_lookup_failed': { title: 'Kon die masterorder niet opzoeken' },
  'order.clone_insert_failed': { title: 'Kon die order niet klonen' },
  'order.master_lines_load_failed': { title: 'Kon de regels van de masterorder niet laden' },
  'order.clone_asset_reservation_failed': { title: 'Kon die assetreservering niet klonen' },
  'order.clone_line_insert_failed': { title: 'Kon die orderregel niet klonen' },
  'order.reeval_booking_lookup_failed': { title: 'Kon de boeking van die order niet hertoetsen' },
  'order.reeval_slot_lookup_failed': { title: 'Kon het slot van die order niet hertoetsen' },
  'order.reeval_catalog_items_load_failed': { title: 'Kon de catalogusitems van die order niet hertoetsen' },
  'order.reeval_menus_load_failed': { title: 'Kon de menu’s van die order niet hertoetsen' },
  'order.line_override_failed': { title: 'Kon die orderregel niet overrulen' },
  'order.line_skip_failed': { title: 'Kon die orderregel niet overslaan' },
  'order.line_revert_failed': { title: 'Kon die orderregel niet terugzetten' },
  'order.services_only_bundle_create_failed': { title: 'Kon die services-only-boeking niet aanmaken' },
  'order.create_failed': { title: 'Kon die order niet aanmaken' },
  'order.catalog_item_lookup_failed': { title: 'Kon dat catalogusitem niet opzoeken' },
  'order.resolve_menu_offer_failed': { title: 'Kon geen menuaanbod vinden' },
  'order.asset_check_failed': { title: 'Kon dat asset niet controleren' },
  'order.asset_reservation_create_failed': { title: 'Kon die assetreservering niet aanmaken' },
  'order.line_item_create_failed': { title: 'Kon die orderregel niet aanmaken' },
  'order.cost_booking_lookup_failed': { title: 'Kon de kostenuitsplitsing van de boeking niet laden' },
  'order.cost_slot_lookup_failed': { title: 'Kon het slot voor kostenuitsplitsing niet laden' },
  'order.cost_orders_list_failed': { title: 'Kon orders voor kostenuitsplitsing niet laden' },
  'order.cost_series_lookup_failed': { title: 'Kon de herhalingsserie voor kostenuitsplitsing niet laden' },
  'order.cost_line_items_load_failed': { title: 'Kon orderregels voor kostenuitsplitsing niet laden' },
  'order.approval_role_expand_failed': { title: 'Kon die goedkeuringsrol niet uitklappen' },
  'order.approval_role_user_lookup_failed': { title: 'Kon gebruikers voor die goedkeuringsrol niet opzoeken' },
  'order.approval_cost_center_lookup_failed': { title: 'Kon het kostencentrum voor goedkeuring niet opzoeken' },
  'order.approval_existing_lookup_failed': { title: 'Kon de bestaande goedkeuring niet opzoeken' },
  'order.approval_scope_merge_failed': { title: 'Kon die goedkeuringsscope niet samenvoegen' },
  'order.approval_insert_failed': { title: 'Kon die goedkeuring niet aanmaken' },

  'ticket.list_failed': { title: 'Kon tickets niet laden' },
  'ticket.lookup_failed': { title: 'Kon dat ticket niet opzoeken' },
  'ticket.work_order_lookup_failed': { title: 'Kon die werkorder niet opzoeken' },
  'ticket.inbox_activities_load_failed': { title: 'Kon inbox-activiteiten niet laden' },
  'ticket.distinct_tags_visible_failed': { title: 'Kon ticket-tags niet laden' },
  'ticket.distinct_tags_failed': { title: 'Kon ticket-tags niet laden' },
  'ticket.permission_check_failed': { title: 'Kon dat ticketrecht niet controleren' },
  'ticket.activities_list_failed': { title: 'Kon ticket-activiteiten niet laden' },
  'ticket.activity_create_failed': { title: 'Kon die ticket-activiteit niet toevoegen' },
  'ticket.attachment_upload_failed': { title: 'Kon die ticket-bijlage niet uploaden' },
  'ticket.attachment_bucket_list_failed': { title: 'Kon ticket-bijlageopslag niet laden' },
  'ticket.attachment_bucket_create_failed': { title: 'Kon ticket-bijlageopslag niet initialiseren' },
  'ticket.child_tasks_list_failed': { title: 'Kon onderliggende ticket-taken niet laden' },
  'ticket.inbox_fetch_failed': { title: 'Kon je ticket-inbox niet laden' },
  'ticket.actor_team_list_failed': { title: 'Kon je teamlidmaatschappen niet laden' },
  'ticket.system_work_order_create_failed': { title: 'Kon die systeem-werkorder niet aanmaken' },
  'ticket.visibility_ids_failed': { title: 'Kon ticket-zichtbaarheid niet bepalen' },
  'ticket.dispatch_child_refetch_failed': { title: 'Kon de gedispatchte werkorder niet laden' },
  'ticket.dispatch_batch_refetch_failed': { title: 'Kon de gedispatchte werkorders niet laden' },

  'user_management.user_create_failed': { title: 'Kon die gebruiker niet aanmaken' },
  'user_management.user_lookup_failed': { title: 'Kon die gebruiker niet opzoeken' },
  'user_management.user_list_failed': { title: 'Kon gebruikers niet laden' },
  'user_management.user_update_failed': { title: 'Kon die gebruiker niet bijwerken' },
  'user_management.user_roles_list_failed': { title: 'Kon de rollen van die gebruiker niet laden' },
  'user_management.role_assignment_create_failed': { title: 'Kon die rol niet toewijzen' },
  'user_management.role_assignment_update_failed': { title: 'Kon die roltoewijzing niet bijwerken' },
  'user_management.role_assignment_remove_failed': { title: 'Kon die roltoewijzing niet intrekken' },
  'user_management.role_list_failed': { title: 'Kon rollen niet laden' },
  'user_management.role_create_failed': { title: 'Kon die rol niet aanmaken' },
  'user_management.role_update_failed': { title: 'Kon die rol niet bijwerken' },
  'user_management.persons_list_failed': { title: 'Kon personen niet laden' },
  'user_management.person_create_failed': { title: 'Kon die persoon niet aanmaken' },
  'user_management.person_update_failed': { title: 'Kon die persoon niet bijwerken' },
  'user_management.role_audit_list_failed': { title: 'Kon het rolaudit-logboek niet laden' },
  ...
  'room_rule.soft_delete_failed': { title: 'Kon die zaalboekingsregel niet verwijderen' },
  'room_rule.versions_list_failed': { title: 'Kon versies van zaalboekingsregels niet laden' },
  'room_rule.version_lookup_failed': { title: 'Kon die versie van de zaalboekingsregel niet opzoeken' },
  'room_rule.scenario_list_failed': { title: 'Kon zaalboeking-simulatiescenario’s niet laden' },
  'room_rule.scenario_create_failed': { title: 'Kon dat simulatiescenario niet aanmaken' },
  'room_rule.scenario_lookup_failed': { title: 'Kon dat simulatiescenario niet opzoeken' },
  'room_rule.active_rules_list_failed': { title: 'Kon actieve zaalboekingsregels niet laden' },
  'room_rule.org_descendants_resolve_failed': { title: 'Kon organisatie-afstammelingen niet bepalen' },
  'room_rule.business_hours_resolve_failed': { title: 'Kon openingstijden niet controleren' },
  'room_rule.candidate_rules_load_failed': { title: 'Kon kandidaat-zaalboekingsregels niet laden' },
  'room_rule.all_rules_load_failed': { title: 'Kon zaalboekingsregels niet laden' },
  'room_rule.ancestor_chain_load_failed': { title: 'Kon de ruimte-hiërarchie niet bepalen' },
  'room_rule.space_chain_load_failed': { title: 'Kon die ruimtes niet ophalen' },
  'room_rule.replay_load_failed': { title: 'Kon boekingen voor impactpreview niet laden' },
  'room_rule.space_descendants_resolve_failed': { title: 'Kon ruimte-afstammelingen niet bepalen' },
  'room_rule.space_names_load_failed': { title: 'Kon ruimtenamen niet laden' },
  'room_rule.person_names_load_failed': { title: 'Kon personen voor impactpreview niet laden' },

  'config_engine.entity_list_failed': { title: 'Kon configuratie-entiteiten niet laden' },
  'config_engine.entity_create_failed': { title: 'Kon die configuratie-entiteit niet aanmaken' },
  'config_engine.draft_create_failed': { title: 'Kon dat configuratieconcept niet aanmaken' },
  'config_engine.draft_update_failed': { title: 'Kon dat configuratieconcept niet bijwerken' },
  'config_engine.publish_failed': { title: 'Kon die configuratieversie niet publiceren' },
  'config_engine.publish_pointer_failed': { title: 'Kon de gepubliceerde configuratieversie niet bijwerken' },
  'config_engine.criteria_set_list_failed': { title: 'Kon criteriasets niet laden' },
  'config_engine.criteria_set_lookup_failed': { title: 'Kon die criteriaset niet opzoeken' },
  'config_engine.criteria_set_create_failed': { title: 'Kon die criteriaset niet aanmaken' },
  'config_engine.criteria_set_update_failed': { title: 'Kon die criteriaset niet bijwerken' },
  'config_engine.criteria_set_match_load_failed': { title: 'Kon de criteriaset-matches niet bekijken' },
  'config_engine.category_list_failed': { title: 'Kon categorieën van de servicecatalogus niet laden' },
  'config_engine.category_tree_load_failed': { title: 'Kon de servicecatalogus-boom niet laden' },
  'config_engine.category_write_failed': { title: 'Kon die categorie niet opslaan' },
  'config_engine.category_delete_failed': { title: 'Kon die categorie niet verwijderen' },
  'config_engine.request_type_list_failed': { title: 'Kon aanvraagtypes niet laden' },
  'config_engine.request_type_lookup_failed': { title: 'Kon dat aanvraagtype niet opzoeken' },
  'config_engine.request_type_create_failed': { title: 'Kon dat aanvraagtype niet aanmaken' },
  'config_engine.request_type_update_failed': { title: 'Kon dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_categories_replace_failed': { title: 'Kon de categorieën van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_categories_list_failed': { title: 'Kon de categorieën van dat aanvraagtype niet laden' },
  'config_engine.request_type_coverage_replace_failed': { title: 'Kon de dekking van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_coverage_list_failed': { title: 'Kon de dekking van dat aanvraagtype niet laden' },
  'config_engine.request_type_audience_replace_failed': { title: 'Kon het publiek van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_audience_list_failed': { title: 'Kon het publiek van dat aanvraagtype niet laden' },
  'config_engine.request_type_form_variants_replace_failed': { title: 'Kon de formuliervarianten van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_form_variants_list_failed': { title: 'Kon de formuliervarianten van dat aanvraagtype niet laden' },
  'config_engine.request_type_on_behalf_replace_failed': { title: 'Kon de namens-regels van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_on_behalf_list_failed': { title: 'Kon de namens-regels van dat aanvraagtype niet laden' },
  'config_engine.request_type_scope_overrides_replace_failed': { title: 'Kon de scope-overrides van dat aanvraagtype niet bijwerken' },
  'config_engine.request_type_scope_overrides_list_failed': { title: 'Kon de scope-overrides van dat aanvraagtype niet laden' },
  'config_engine.request_type_reorder_failed': { title: 'Kon dat aanvraagtype niet opnieuw ordenen' },
  'config_engine.request_type_unlink_failed': { title: 'Kon dat aanvraagtype niet ontkoppelen' },
  'config_engine.request_type_link_failed': { title: 'Kon dat aanvraagtype niet koppelen' },
  'config_engine.coverage_matrix_failed': { title: 'Kon de dekkingsmatrix niet laden' },
  'config_engine.name_hydrate_failed': { title: 'Kon referentienamen niet laden' },
  'config_engine.tenant_ids_check_failed': { title: 'Kon die tenantreferenties niet verifiëren' },
  'config_engine.config_entities_type_check_failed': { title: 'Kon die configuratie-entiteit-referenties niet verifiëren' },

  // ─── F1 Sub-PR B — wrapPgError sweep, remaining 20 modules (2026-05-21) ──
  'search.global_search_failed': { title: 'Kon die zoekopdracht niet uitvoeren' },
  'outbox.mark_consumed_failed': { title: 'Kon dat outbox-event niet bevestigen' },
  'tenant.meal_windows_list_failed': { title: 'Kon maaltijdvensters niet laden' },

  'sla.target_update_failed': { title: 'Kon dat SLA-doel niet bijwerken' },
  'sla.timers_list_failed': { title: 'Kon SLA-timers niet laden' },
  'sla.user_person_lookup_failed': { title: 'Kon die gebruiker niet vinden' },
  'sla.crossing_write_failed': { title: 'Kon die SLA-drempeloverschrijding niet vastleggen' },
  'sla.crossings_list_failed': { title: 'Kon SLA-drempeloverschrijdingen niet laden' },

  'space.list_failed': { title: 'Kon ruimtes niet laden' },
  'space.hierarchy_load_failed': { title: 'Kon de ruimte-hiërarchie niet laden' },
  'space.create_failed': { title: 'Kon die ruimte niet aanmaken' },
  'space.update_failed': { title: 'Kon die ruimte niet bijwerken' },
  'space.move_failed': { title: 'Kon die ruimte niet verplaatsen' },

  'cost_center.list_failed': { title: 'Kon kostenplaatsen niet laden' },
  'cost_center.lookup_failed': { title: 'Kon die kostenplaats niet opzoeken' },
  'cost_center.create_failed': { title: 'Kon die kostenplaats niet aanmaken' },
  'cost_center.update_failed': { title: 'Kon die kostenplaats niet bijwerken' },
  'cost_center.delete_failed': { title: 'Kon die kostenplaats niet verwijderen' },

  'bundle_template.list_failed': { title: 'Kon bundelsjablonen niet laden' },
  'bundle_template.lookup_failed': { title: 'Kon dat bundelsjabloon niet opzoeken' },
  'bundle_template.create_failed': { title: 'Kon dat bundelsjabloon niet aanmaken' },
  'bundle_template.update_failed': { title: 'Kon dat bundelsjabloon niet bijwerken' },
  'bundle_template.delete_failed': { title: 'Kon dat bundelsjabloon niet verwijderen' },

  'service_routing.list_failed': { title: 'Kon serviceroutering-regels niet laden' },
  'service_routing.lookup_failed': { title: 'Kon die serviceroutering-regel niet opzoeken' },
  'service_routing.create_failed': { title: 'Kon die serviceroutering-regel niet aanmaken' },
  'service_routing.update_failed': { title: 'Kon die serviceroutering-regel niet bijwerken' },
  'service_routing.delete_failed': { title: 'Kon die serviceroutering-regel niet verwijderen' },

  'approval.pending_for_actor_failed': { title: 'Kon je openstaande goedkeuringen niet laden' },
  'approval.pending_count_failed': { title: 'Kon je openstaande goedkeuringen niet tellen' },
  'approval.pending_stale_probe_failed': { title: 'Kon je openstaande goedkeuringen niet controleren' },
  'approval.for_entity_failed': { title: 'Kon goedkeuringen voor dat item niet laden' },
  'approval.create_single_step_failed': { title: 'Kon die goedkeuringsaanvraag niet aanmaken' },
  'approval.create_sequential_chain_failed': { title: 'Kon die goedkeuringsketen niet aanmaken' },
  'approval.create_parallel_group_failed': { title: 'Kon die goedkeuringsgroep niet aanmaken' },
  'approval.respond_update_failed': { title: 'Kon die goedkeuringsreactie niet vastleggen' },

  'routing.coverage_resolve_failed': { title: 'Kon routeringsdekking niet bepalen' },
  'routing.coverage_domains_load_failed': { title: 'Kon routeringsdomeinen niet laden' },
  'routing.coverage_spaces_load_failed': { title: 'Kon routeringsruimtes niet laden' },
  'routing.simulator_request_type_lookup_failed': { title: 'Kon dat aanvraagtype niet laden' },
  'routing.scope_override_resolve_failed': { title: 'Kon die scope-override niet bepalen' },
  'routing.decisions_list_failed': { title: 'Kon routeringsbeslissingen niet laden' },
  'routing.dualrun_logs_list_failed': { title: 'Kon routeringsvergelijkingen niet laden' },

  'bundle.visibility_approval_probe_failed': { title: 'Kon zichtbaarheid van die boeking niet controleren' },
  'bundle.visibility_work_order_probe_failed': { title: 'Kon zichtbaarheid van die boeking niet controleren' },
  'bundle.cascade_line_lookup_failed': { title: 'Kon die boekingsregel niet opzoeken' },
  'bundle.cascade_order_lookup_failed': { title: 'Kon die boekingsorder niet opzoeken' },
  'bundle.cascade_booking_lookup_failed': { title: 'Kon die boeking niet opzoeken' },
  'bundle.attach_plan_asset_lookup_failed': { title: 'Kon dat object niet opzoeken' },
  'bundle.add_lines_booking_lookup_failed': { title: 'Kon die boeking niet opzoeken' },
  'bundle.load_booking_failed': { title: 'Kon die boeking niet laden' },

  'org_node.list_failed': { title: 'Kon organisaties niet laden' },
  'org_node.member_count_failed': { title: 'Kon organisatieleden niet tellen' },
  'org_node.grant_count_failed': { title: 'Kon organisatie-toekenningen niet tellen' },
  'org_node.team_count_failed': { title: 'Kon teams van de organisatie niet tellen' },
  'org_node.lookup_failed': { title: 'Kon die organisatie niet opzoeken' },
  'org_node.demote_primary_failed': { title: 'Kon dat organisatielidmaatschap niet bijwerken' },
  'org_node.list_members_failed': { title: 'Kon organisatieleden niet laden' },
  'org_node.remove_member_failed': { title: 'Kon dat organisatielidmaatschap niet verwijderen' },
  'org_node.list_grants_failed': { title: 'Kon organisatie-toekenningen niet laden' },
  'org_node.remove_grant_failed': { title: 'Kon die organisatie-toekenning niet verwijderen' },
  'org_node.list_attached_teams_failed': { title: 'Kon teams van de organisatie niet laden' },

  'portal.onboardable_locations_failed': { title: 'Kon locaties niet laden' },
  'portal.claim_default_location_failed': { title: 'Kon je standaardlocatie niet instellen' },
  'portal.update_profile_failed': { title: 'Kon je profiel niet bijwerken' },
  'portal.avatar_upload_failed': { title: 'Kon die avatar niet uploaden' },
  'portal.avatar_update_failed': { title: 'Kon die avatar niet opslaan' },
  'portal.remove_avatar_failed': { title: 'Kon die avatar niet verwijderen' },
  'portal.catalog_visible_ids_failed': { title: 'Kon de catalogus niet laden' },
  'portal.catalog_criteria_match_failed': { title: 'Kon dat catalogus-criterium niet evalueren' },
  'portal.authorized_root_matches_failed': { title: 'Kon je gemachtigde locaties niet laden' },
  'portal.authorized_space_ids_failed': { title: 'Kon je gemachtigde locaties niet laden' },

  'calendar_sync.my_link_lookup_failed': { title: 'Kon je agendakoppeling niet laden' },
  'calendar_sync.connect_upsert_failed': { title: 'Kon die agenda niet koppelen' },
  'calendar_sync.force_resync_link_lookup_failed': { title: 'Kon die agendakoppeling niet laden' },
  'calendar_sync.health_spaces_failed': { title: 'Kon agenda-gesynchroniseerde ruimtes niet laden' },
  'calendar_sync.conflicts_list_failed': { title: 'Kon agendaconflicten niet laden' },
  'calendar_sync.resolve_conflict_update_failed': { title: 'Kon dat agendaconflict niet oplossen' },
  'calendar_sync.actor_resolve_failed': { title: 'Kon je account niet bepalen' },
  'calendar_sync.reconciler_spaces_load_failed': { title: 'Kon agenda-gesynchroniseerde ruimtes niet laden' },
  'calendar_sync.reconciler_reservations_load_failed': { title: 'Kon boekingen voor reconciliatie niet laden' },

  'service_rule.resolver_load_failed': { title: 'Kon actieve serviceregels niet laden' },
  'service_rule.list_failed': { title: 'Kon serviceregels niet laden' },
  'service_rule.lookup_failed': { title: 'Kon die serviceregel niet opzoeken' },
  'service_rule.create_failed': { title: 'Kon die serviceregel niet aanmaken' },
  'service_rule.update_failed': { title: 'Kon die serviceregel niet bijwerken' },
  'service_rule.delete_failed': { title: 'Kon die serviceregel niet verwijderen' },
  'service_rule.templates_list_failed': { title: 'Kon sjablonen van serviceregels niet laden' },
  'service_rule.template_lookup_failed': { title: 'Kon dat sjabloon van een serviceregel niet opzoeken' },
  'service_rule.create_from_template_failed': { title: 'Kon die serviceregel niet aanmaken vanuit sjabloon' },

  'visitors.pending_hosts_load_failed': { title: 'Kon openstaande gastheren niet laden' },
  'visitors.visitor_lookup_failed': { title: 'Kon die bezoeker niet opzoeken' },
  'visitors.hosts_load_failed': { title: 'Kon gastheren van die bezoeker niet laden' },
  'visitors.kiosk_token_rotate_failed': { title: 'Kon dat kiosk-token niet roteren' },
  'visitors.kiosk_token_revoke_failed': { title: 'Kon dat kiosk-token niet intrekken' },
  'visitors.invitation_scope_check_failed': { title: 'Kon je uitnodigingsscope niet controleren' },
  'visitors.visitor_type_lookup_failed': { title: 'Kon dat bezoekerstype niet opzoeken' },
  'visitors.dedup_lookup_failed': { title: 'Kon bestaande bezoekers niet controleren' },

  'webhook.events_list_failed': { title: 'Kon webhook-gebeurtenissen niet laden' },
  'webhook.auth_lookup_failed': { title: 'Kon die webhook-sleutel niet verifiëren' },
  'webhook.list_failed': { title: 'Kon webhooks niet laden' },
  'webhook.create_failed': { title: 'Kon die webhook niet aanmaken' },
  'webhook.update_failed': { title: 'Kon die webhook niet bijwerken' },
  'webhook.delete_failed': { title: 'Kon die webhook niet verwijderen' },
  'webhook.rotate_api_key_failed': { title: 'Kon die webhook-sleutel niet roteren' },
  'webhook.lookup_failed': { title: 'Kon die webhook niet opzoeken' },

  'work_order.planning_user_labels_failed': { title: 'Kon plannings-gebruikerslabels niet laden' },
  'work_order.planning_team_labels_failed': { title: 'Kon plannings-teamlabels niet laden' },
  'work_order.planning_vendor_labels_failed': { title: 'Kon plannings-leverancierslabels niet laden' },
  'work_order.planning_request_types_failed': { title: 'Kon plannings-aanvraagtypes niet laden' },
  'work_order.planning_parent_case_teams_failed': { title: 'Kon teams van bovenliggende cases niet laden' },
  'work_order.planning_team_roster_failed': { title: 'Kon dat teamoverzicht niet laden' },
  'work_order.planning_active_vendors_failed': { title: 'Kon actieve leveranciers niet laden' },
  'work_order.sla_policy_lookup_failed': { title: 'Kon dat SLA-beleid niet opzoeken' },
  'work_order.permission_probe_failed': { title: 'Kon die permissie niet controleren' },

  'workflow.list_failed': { title: 'Kon workflows niet laden' },
  'workflow.create_failed': { title: 'Kon die workflow niet aanmaken' },
  'workflow.update_graph_failed': { title: 'Kon die workflow niet opslaan' },
  'workflow.publish_failed': { title: 'Kon die workflow niet publiceren' },
  'workflow.unpublish_failed': { title: 'Kon die workflow niet ongepubliceerd maken' },
  'workflow.clone_failed': { title: 'Kon die workflow niet klonen' },
  'workflow.instances_for_ticket_failed': { title: 'Kon workflow-instanties niet laden' },
  'workflow.instance_events_list_failed': { title: 'Kon workflow-gebeurtenissen niet laden' },
  'workflow.instance_create_ticket_failed': { title: 'Kon die workflow niet starten' },
  'workflow.instance_create_booking_failed': { title: 'Kon die workflow niet starten' },
};

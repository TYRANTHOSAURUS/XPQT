...
export const ERROR_MESSAGES_EN: Record<KnownErrorCode, ErrorMessage> = {
  ...
  // Voice: "Couldn't <verb> <thing>" per spec §3.4. Detail is operator-only
  // and passed at the throw site.
  'search.global_search_failed': { title: "Couldn't run that search" },
  'outbox.mark_consumed_failed': { title: "Couldn't acknowledge that outbox event" },
  'tenant.meal_windows_list_failed': { title: "Couldn't load meal windows" },

  'sla.target_update_failed': { title: "Couldn't update that SLA target" },
  'sla.timers_list_failed': { title: "Couldn't load SLA timers" },
  'sla.user_person_lookup_failed': { title: "Couldn't resolve that user" },
  'sla.crossing_write_failed': { title: "Couldn't record that SLA threshold crossing" },
  'sla.crossings_list_failed': { title: "Couldn't load SLA threshold crossings" },

  'space.list_failed': { title: "Couldn't load spaces" },
  'space.hierarchy_load_failed': { title: "Couldn't load the space hierarchy" },
  'space.create_failed': { title: "Couldn't create that space" },
  'space.update_failed': { title: "Couldn't update that space" },
  'space.move_failed': { title: "Couldn't move that space" },

  'cost_center.list_failed': { title: "Couldn't load cost centers" },
  'cost_center.lookup_failed': { title: "Couldn't look up that cost center" },
  'cost_center.create_failed': { title: "Couldn't create that cost center" },
  'cost_center.update_failed': { title: "Couldn't update that cost center" },
  'cost_center.delete_failed': { title: "Couldn't delete that cost center" },

  'bundle_template.list_failed': { title: "Couldn't load bundle templates" },
  'bundle_template.lookup_failed': { title: "Couldn't look up that bundle template" },
  'bundle_template.create_failed': { title: "Couldn't create that bundle template" },
  'bundle_template.update_failed': { title: "Couldn't update that bundle template" },
  'bundle_template.delete_failed': { title: "Couldn't delete that bundle template" },

  'service_routing.list_failed': { title: "Couldn't load service routing rules" },
  'service_routing.lookup_failed': { title: "Couldn't look up that service routing rule" },
  'service_routing.create_failed': { title: "Couldn't create that service routing rule" },
  'service_routing.update_failed': { title: "Couldn't update that service routing rule" },
  'service_routing.delete_failed': { title: "Couldn't delete that service routing rule" },

  'approval.pending_for_actor_failed': { title: "Couldn't load your pending approvals" },
  'approval.pending_count_failed': { title: "Couldn't count your pending approvals" },
  'approval.pending_stale_probe_failed': { title: "Couldn't check your pending approvals" },
  'approval.for_entity_failed': { title: "Couldn't load approvals for that item" },
  'approval.create_single_step_failed': { title: "Couldn't create that approval request" },
  'approval.create_sequential_chain_failed': { title: "Couldn't create that approval chain" },
  'approval.create_parallel_group_failed': { title: "Couldn't create that approval group" },
  'approval.respond_update_failed': { title: "Couldn't record that approval response" },

  'routing.coverage_resolve_failed': { title: "Couldn't resolve routing coverage" },
  'routing.coverage_domains_load_failed': { title: "Couldn't load routing domains" },
  'routing.coverage_spaces_load_failed': { title: "Couldn't load routing spaces" },
  'routing.simulator_request_type_lookup_failed': { title: "Couldn't load that request type" },
  'routing.scope_override_resolve_failed': { title: "Couldn't resolve that scope override" },
  'routing.decisions_list_failed': { title: "Couldn't load routing decisions" },
  'routing.dualrun_logs_list_failed': { title: "Couldn't load routing comparison logs" },

  'bundle.visibility_approval_probe_failed': { title: "Couldn't check booking visibility" },
  'bundle.visibility_work_order_probe_failed': { title: "Couldn't check booking visibility" },
  'bundle.cascade_line_lookup_failed': { title: "Couldn't look up that booking line" },
  'bundle.cascade_order_lookup_failed': { title: "Couldn't look up that booking order" },
  'bundle.cascade_booking_lookup_failed': { title: "Couldn't look up that booking" },
  'bundle.attach_plan_asset_lookup_failed': { title: "Couldn't look up that asset" },
  'bundle.add_lines_booking_lookup_failed': { title: "Couldn't look up that booking" },
  'bundle.load_booking_failed': { title: "Couldn't load that booking" },

  'org_node.list_failed': { title: "Couldn't load organisations" },
  'org_node.member_count_failed': { title: "Couldn't count organisation members" },
  'org_node.grant_count_failed': { title: "Couldn't count organisation grants" },
  'org_node.team_count_failed': { title: "Couldn't count organisation teams" },
  'org_node.lookup_failed': { title: "Couldn't look up that organisation" },
  'org_node.demote_primary_failed': { title: "Couldn't update that organisation membership" },
  'org_node.list_members_failed': { title: "Couldn't load organisation members" },
  'org_node.remove_member_failed': { title: "Couldn't remove that organisation member" },
  'org_node.list_grants_failed': { title: "Couldn't load organisation grants" },
  'org_node.remove_grant_failed': { title: "Couldn't remove that organisation grant" },
  'org_node.list_attached_teams_failed': { title: "Couldn't load organisation teams" },

  'portal.onboardable_locations_failed': { title: "Couldn't load locations" },
  'portal.claim_default_location_failed': { title: "Couldn't set your default location" },
  'portal.update_profile_failed': { title: "Couldn't update your profile" },
  'portal.avatar_upload_failed': { title: "Couldn't upload that avatar" },
  'portal.avatar_update_failed': { title: "Couldn't save that avatar" },
  'portal.remove_avatar_failed': { title: "Couldn't remove that avatar" },
  'portal.catalog_visible_ids_failed': { title: "Couldn't load the catalog" },
  'portal.catalog_criteria_match_failed': { title: "Couldn't evaluate that catalog criterion" },
  'portal.authorized_root_matches_failed': { title: "Couldn't load your authorized locations" },
  'portal.authorized_space_ids_failed': { title: "Couldn't load your authorized locations" },

  'calendar_sync.my_link_lookup_failed': { title: "Couldn't load your calendar link" },
  'calendar_sync.connect_upsert_failed': { title: "Couldn't connect that calendar" },
  'calendar_sync.force_resync_link_lookup_failed': { title: "Couldn't load that calendar link" },
  'calendar_sync.health_spaces_failed': { title: "Couldn't load calendar-synced spaces" },
  'calendar_sync.conflicts_list_failed': { title: "Couldn't load calendar conflicts" },
  'calendar_sync.resolve_conflict_update_failed': { title: "Couldn't resolve that calendar conflict" },
  'calendar_sync.actor_resolve_failed': { title: "Couldn't resolve your account" },
  'calendar_sync.reconciler_spaces_load_failed': { title: "Couldn't load calendar-synced spaces" },
  'calendar_sync.reconciler_reservations_load_failed': { title: "Couldn't load bookings for reconciliation" },

  'service_rule.resolver_load_failed': { title: "Couldn't load active service rules" },
  'service_rule.list_failed': { title: "Couldn't load service rules" },
  'service_rule.lookup_failed': { title: "Couldn't look up that service rule" },
  'service_rule.create_failed': { title: "Couldn't create that service rule" },
  'service_rule.update_failed': { title: "Couldn't update that service rule" },
  'service_rule.delete_failed': { title: "Couldn't delete that service rule" },
  'service_rule.templates_list_failed': { title: "Couldn't load service rule templates" },
  'service_rule.template_lookup_failed': { title: "Couldn't look up that service rule template" },
  'service_rule.create_from_template_failed': { title: "Couldn't create that service rule from template" },

  'visitors.pending_hosts_load_failed': { title: "Couldn't load pending hosts" },
  'visitors.visitor_lookup_failed': { title: "Couldn't look up that visitor" },
  'visitors.hosts_load_failed': { title: "Couldn't load visitor hosts" },
  'visitors.kiosk_token_rotate_failed': { title: "Couldn't rotate that kiosk token" },
  'visitors.kiosk_token_revoke_failed': { title: "Couldn't revoke that kiosk token" },
  'visitors.invitation_scope_check_failed': { title: "Couldn't check your invitation scope" },
  'visitors.visitor_type_lookup_failed': { title: "Couldn't look up that visitor type" },
  'visitors.dedup_lookup_failed': { title: "Couldn't check existing visitors" },

  'webhook.events_list_failed': { title: "Couldn't load webhook events" },
  'webhook.auth_lookup_failed': { title: "Couldn't verify that webhook key" },
  'webhook.list_failed': { title: "Couldn't load webhooks" },
  'webhook.create_failed': { title: "Couldn't create that webhook" },
  'webhook.update_failed': { title: "Couldn't update that webhook" },
  'webhook.delete_failed': { title: "Couldn't delete that webhook" },
  'webhook.rotate_api_key_failed': { title: "Couldn't rotate that webhook key" },
  'webhook.lookup_failed': { title: "Couldn't look up that webhook" },

  'work_order.planning_user_labels_failed': { title: "Couldn't load planning user labels" },
  'work_order.planning_team_labels_failed': { title: "Couldn't load planning team labels" },
  'work_order.planning_vendor_labels_failed': { title: "Couldn't load planning vendor labels" },
  'work_order.planning_request_types_failed': { title: "Couldn't load planning request types" },
  'work_order.planning_parent_case_teams_failed': { title: "Couldn't load parent case teams" },
  'work_order.planning_team_roster_failed': { title: "Couldn't load that team roster" },
  'work_order.planning_active_vendors_failed': { title: "Couldn't load active vendors" },
  'work_order.sla_policy_lookup_failed': { title: "Couldn't look up that SLA policy" },
  'work_order.permission_probe_failed': { title: "Couldn't check that permission" },

  'workflow.list_failed': { title: "Couldn't load workflows" },
  'workflow.create_failed': { title: "Couldn't create that workflow" },
  'workflow.update_graph_failed': { title: "Couldn't save that workflow" },
  'workflow.publish_failed': { title: "Couldn't publish that workflow" },
  'workflow.unpublish_failed': { title: "Couldn't unpublish that workflow" },
  'workflow.clone_failed': { title: "Couldn't clone that workflow" },
  'workflow.instances_for_ticket_failed': { title: "Couldn't load workflow instances" },
  'workflow.instance_events_list_failed': { title: "Couldn't load workflow events" },
  'workflow.instance_create_ticket_failed': { title: "Couldn't start that workflow" },
  'workflow.instance_create_booking_failed': { title: "Couldn't start that workflow" },
};

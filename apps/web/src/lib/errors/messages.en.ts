 ...
 *
 * Mirrors the canonical server table (`apps/api/src/common/errors/messages.en.ts`),
 * trimmed to codes that may surface to a user. Internal-only namespaces
 * (`outbox.*`, `setup_wo.*`) and the bare `validation.failed` (always
 * overridden by `fields[]`) are intentionally absent — the renderer falls
 * back to `unknown.server_error` for unregistered codes per fail-closed
 * (spec §3.4 / decision #9).
 *
 ...
 *
 * Coverage drift between client + server is enforced by `messages.test.ts`.
 *
...
/**
 * Server-side namespaces / codes that we DON'T mirror because they never
 * surface to a logged-in end user (only internal-system / ops paths).
 * Used by `messages.test.ts` to compute coverage drift.
 */
export const INTERNAL_ONLY_PREFIXES = ['outbox.', 'setup_wo.'] as const;
export const INTERNAL_ONLY_CODES = new Set<string>([
  // The bare validation umbrella — always overridden by per-field details.
  'validation.failed',
]);
...
export const ERROR_MESSAGES_EN: Record<string, ErrorMessage> = {
  ...
  'auth.missing_user': { title: 'Sign in to continue' },
  'auth.missing_header': {
    title: 'Sign in to continue',
  ...
  'auth.role_lookup_failed': { title: "Couldn't verify access" },
  'auth.user_not_in_tenant': { title: "You don't have access here" },
  'auth.admin_required': {
  ...
  'work_order.not_found': { title: "Couldn't find that work order" },
  ...
  'ticket.no_files_uploaded': { title: "Couldn't upload — no files attached" },
  'ticket.visibility_trace_forbidden': { title: "You don't have access to this" },
  'ticket.plan_forbidden': { title: "You can't plan this ticket" },
  'ticket.bulk_update_invalid': { title: "Couldn't bulk-update — input invalid" },
  'ticket.reassignment_reason_required': {
    title: "Couldn't reassign — reason required",
  },
  'ticket.priority_change_forbidden': { title: "You can't change ticket priority" },
  'ticket.assign_forbidden': { title: "You can't change ticket assignment" },
  ...
  'booking.slot_update_failed': { title: "Couldn't update that slot" },
  ...
  'booking.too_early_to_check_in': { title: "It's too early to check in" },
  'booking.already_ended': { title: 'This booking has already ended' },
  'booking.already_checked_in': { title: 'Already checked in' },
  'booking.not_confirmed': {
    title: "Couldn't check in — booking not confirmed",
  },
  'booking.check_in_failed': { title: "Couldn't check in" },
  'booking.magic_link_invalid': { title: 'That check-in link is invalid' },
  ...
  'booking.restore_failed': { title: "Couldn't restore the booking" },
  ...
  'booking.master_not_found': { title: "Couldn't find the master booking" },
  'booking.recurrence_failed': { title: "Couldn't update the recurrence" },

  'booking_slot.not_found': { title: "Couldn't find that booking slot" },
  ...
  // ─── booking-bundles ─────────────────────────────────────────────────────
  'bundle.forbidden': { title: "You don't have access to this booking" },
  'bundle.not_found': { title: "We can't find that booking" },
  'bundle.no_services': {
  ...
  // ─── catalog / order / asset ─────────────────────────────────────────────
  'asset.not_found': { title: "We can't find that asset" },
  'catalog_item.not_found': { title: "We can't find that catalog item" },
  service_rule_deny: { title: "Couldn't book — a rule blocked it" },
  asset_conflict: {
    title: "Couldn't book — asset already reserved",
    detail: 'A requested asset is already reserved for that window.',
  },
  line_not_found: { title: "We can't find that line" },
  line_state_changed: {
  ...
  client_line_id_required: { title: "Couldn't save — missing client line id" },
  client_line_id_not_unique: { title: "Couldn't save — duplicate client line id" },
  ...
  'routing.invalid_state': {
    title: "Couldn't process",
    detail: 'Invalid state for this action.',
  },
  'routing.v2_not_implemented': { title: "That feature isn't available yet" },
  'sla.policy_invalid': { title: "Couldn't apply SLA — policy invalid" },
  ...
  'reference.field_invalid': {
    title: "Couldn't save",
    detail: 'A referenced field is invalid.',
  },
  'reference.invalid_array_size': {
    title: "Couldn't save",
    detail: 'Array exceeds the allowed size.',
  },
  ...
  'visitor.config_missing': {
    title: "Couldn't process",
    detail: 'Visitor service is not configured.',
  },
  ...
  'pool_anchor.invalid': {
    title: "Couldn't process",
    detail: 'Pool anchor must be a site or building.',
  },
  ...
  'portal.no_user_in_tenant': { title: 'No user in this tenant' },
  ...
  'portal.parent_space_not_found': {
    title: "Couldn't find that parent location",
  },
  ...
  'space.parent_not_found': { title: "Couldn't find the parent space" },
  ...
  'webhook.invalid_mapping': { title: "Couldn't save that webhook mapping" },
  ...
  'webhook.inactive': {
    title: 'That webhook is inactive',
  ...
  code_required: { title: "Couldn't save", detail: 'Code is required.' },
  code_too_long: {
    title: "Couldn't save",
  ...
  // ─── bundle-templates ────────────────────────────────────────────────────
  bundle_template_not_found: { title: "Couldn't find that bundle template" },
  invalid_services: {
  ...
  // ─── service-catalog ─────────────────────────────────────────────────────
  service_rule_not_found: { title: "Couldn't find that service rule" },
  name_required: { title: "Couldn't save", detail: 'Name is required.' },
  invalid_predicate: {
  ...
  template_not_found: { title: "Couldn't find that template" },
  ...
  'portal_appearance.list_failed': { title: "Couldn't load portal appearance" },
  'portal_appearance.upsert_failed': { title: "Couldn't save portal appearance" },
  'portal_appearance.upsert_no_row': { title: "Couldn't save portal appearance" },
  'portal_appearance.upload_failed': { title: "Couldn't upload that image" },
  'portal_appearance.delete_failed': { title: "Couldn't delete portal appearance" },

  // ─── announcement ────────────────────────────────────────────────────────
  'announcement.list_failed': { title: "Couldn't load announcements" },
  'announcement.publish_failed': { title: "Couldn't publish that announcement" },
  'announcement.unpublish_failed': { title: "Couldn't unpublish that announcement" },
  'announcement.invalid_payload': {
    title: "Couldn't publish that announcement",
    detail: 'Location, title, and body are required.',
  },
  'announcement.insert_no_row': { title: "Couldn't save that announcement" },
  ...
  'org_node.not_found': { title: "Couldn't find that organisation node" },
  'org_node.name_required': {
    title: "Couldn't save that organisation node",
    detail: 'Name is required.',
  },
  'org_node.create_failed': { title: "Couldn't create that organisation node" },
  'org_node.update_failed': { title: "Couldn't update that organisation node" },
  'org_node.delete_failed': { title: "Couldn't delete that organisation node" },
  ...
  'org_node.add_member_failed': { title: "Couldn't add that member" },
  'org_node.add_grant_failed': { title: "Couldn't add that location grant" },
  ...
  'report.rpc_failed': { title: "Couldn't run that report" },
  'report.invalid_date': {
    title: "Couldn't run that report",
  ...
  'daily_list.invalid_vendor': {
    title: "Couldn't process that request",
    detail: 'Vendor is not configured for daily lists.',
  },
  ...
  'daily_list.pdf_missing': {
    title: "Couldn't render daily list",
    detail: 'PDF storage path is missing.',
  },
  ...
  'config_engine.criteria_set_not_found': {
    title: "Couldn't find that criteria set",
  },
  ...
  'config_engine.invalid_request_type': {
    title: "Couldn't save that request type",
  },
  'config_engine.request_type_not_found': {
    title: "Couldn't find that request type",
  },
  ...
  'calendar_sync.invalid_state': {
    ...
    detail: 'OAuth state is unknown or expired.',
  },
  'calendar_sync.state_user_mismatch': {
    title: "Couldn't complete sign-in",
    detail: 'OAuth state belongs to another user.',
  },
  ...
  'calendar_sync.conflict_not_open': {
    title: "Couldn't update that conflict",
    detail: 'Conflict is no longer open.',
  },
  ...
  'vendor_portal.invalid_role': {
    title: "Couldn't save",
    detail: 'Role must be fulfiller or manager.',
  },
  ...
  'vendor_portal.invalid_transition': {
    ...
    detail: "That status transition isn't allowed.",
  },
  ...
  'privacy.retention_not_found': {
    title: "Couldn't find those retention settings",
  },
  ...
  no_person: {
    title: 'No profile found',
    detail: "Your account isn't linked to a person.",
  },
  ...
  'orders.not_implemented': { title: "That feature isn't available yet" },
  ...
  'mail.config_missing': {
    ...
    detail: 'Mail provider is not configured.',
  },
  'mail.dispatch_failed': { title: "Couldn't send that email" },
  'mail.invalid_recipient': {
    title: "Couldn't send that email",
    detail: 'Recipient address is invalid.',
  },
  ...
  override_reason_required: { title: "Couldn't book — override reason required" },
  multi_room_recurrence_unsupported: {
    title: "Couldn't book — recurrence with multiple rooms isn't supported",
  },
  wrong_endpoint: { title: "Couldn't update — wrong endpoint" },
  recurrence_unavailable: { title: 'Recurrence not available here' },
  edit_scope_failed: { title: "Couldn't apply that edit" },
  not_recurring: { title: "This booking isn't recurring" },
  reservation_write_forbidden: { title: "You can't change this booking" },
  invalid_input: { title: "Couldn't save — input invalid" },
  permission_denied: { title: "You don't have access to this" },
  book_on_behalf_forbidden: { title: "You can't book on behalf of another person" },
  multi_room_booking_failed: { title: "Couldn't book the rooms" },
  ...
  rule_deny: { title: "Couldn't book — a rule blocked it" },
  reservation_not_visible: { title: "You don't have access to this booking" },
  reservation_operator_required: {
    title: "You need operator access for this view",
  },
  booking_not_found: { title: "We can't find that booking" },
  booking_not_editable: { title: "You can't edit this booking" },
  booking_completed: { title: 'That booking is completed' },
  not_a_recurring_occurrence: {
    title: "Couldn't update — not a recurring occurrence",
  },
  booking_slot_taken: { title: "Couldn't restore — slot is taken" },
  booking_already_ended: { title: 'This booking has already ended' },
  booking_too_early_to_check_in: { title: "It's too early to check in" },
  booking_already_checked_in: { title: 'Already checked in' },
  booking_not_confirmed: { title: "Couldn't check in — booking not confirmed" },
  check_in_failed: { title: "Couldn't check in" },
  magic_link_invalid: { title: 'That check-in link is invalid' },
  ...
  booking_not_cancelled: { title: "Couldn't restore — booking isn't cancelled" },
  ...
  group_siblings_failed: { title: "Couldn't load the group siblings" },
  list_for_operator_failed: { title: "Couldn't load the bookings" },
  ...
  // self-review I3 (2026-05-12): voice-neutralised. See server-side
  // apps/api/src/common/errors/messages.en.ts for rationale; same copy
  // here so client-side fallback rendering matches.
  ...
  // notification dispatch. Copy mirrors the server registry so render
  // fallbacks match.
  ...
  // B.4 Step 2F.2 — assembleScopeEditPlan defensive codes. Surfaces match
  // the api-side messages (single source of truth at api/messages.en.ts;
  // web mirror so the renderer can resolve before any network round-trip).

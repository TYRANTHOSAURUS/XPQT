...
**No changes needed** to `portal_authorized_space_ids`, `portal_match_authorized_root`, `portal_visible_request_type_ids`, or `portal_availability_trace` beyond the tie-break extension above. They all compose on `portal_authorized_root_matches`.
